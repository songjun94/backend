 ...
 * Generated at: 2022-05-16 07:58:03 UTC
 ...
 request.setCharacterEncoding("UTF-8"); 
      ...
      out.write("	");
		...
		if (user.getUserID() == null || user.getUserPassword() == null || user.getUserName() == null 
			|| user.getUserAge() == null || user.getUserGender() == null || user.getUserAddress() == null || user.getUserPhone() == null)
		{
			PrintWriter script = response.getWriter();
	 		script.println("<script>");
	 		script.println("alert('입력란이 비어있습니다.')");
