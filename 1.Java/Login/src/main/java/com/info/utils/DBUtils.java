...
public class DBUtils {
	...
	private static final String DATABASE_NAME = "team5db";
...
//		Class.forName(DRIVER_NAME); // 과거의 사용 방식
	...
	public static void dropAndCreateTable() {
		...
		try (Connection connection = getConnection();
			...
			final String dropTableQueryIfExists = "DROP TABLE IF EXISTS info";
			...
			final String createTableQuery = 
	            "CREATE TABLE info (" +
	            "info_number SMALLINT(5) unsigned NOT NULL AUTO_INCREMENT," +
	            "name VARCHAR(255)," +
	            "age VARCHAR(255)," +
	            "gender VARCHAR(255)," +
	            "address VARCHAR(255)" +
